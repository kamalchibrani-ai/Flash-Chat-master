...
class ChatViewController: UIViewController , UITableViewDelegate , UITableViewDataSource  , UITextFieldDelegate{
    ...
    func retrieveMessages() {
        ...
        messageDB.observe(.childAdded) { (snapshot) in
            ...
            let textMessage = snapshotValue["messageBody"]!
            let textMessageSender = snapshotValue["sender"]!
            
            print(textMessage , textMessageSender)
            
            let messageObject = Message()
            messageObject.messageBody = textMessage
            messageObject.sender = textMessageSender
